...
| [`zsh-config-reviewer`](.claude/agents/zsh-config-reviewer.md)       | Reviewing `configs/shell/` changes — `zsh -n` syntax, protected fzf files, keybinding fragments, sourced-path resolution, guard removal.           |

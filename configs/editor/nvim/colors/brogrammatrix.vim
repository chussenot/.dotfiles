...
let g:colors_name = "brogrammatrix"

hi Cursor ctermfg=234 ctermbg=231 cterm=NONE guifg=#040404 guibg=#ecf0f1 gui=NONE
...
hi Folded ctermfg=241 ctermbg=234 cterm=NONE guifg=#606060 guibg=#040404 gui=NONE
hi TabLine ctermfg=241 ctermbg=234 cterm=NONE guifg=#606060 guibg=#040404 gui=NONE
hi TabLineSel ctermfg=255 ctermbg=234 cterm=NONE guifg=#eeeeee guibg=#040404 gui=NONE
hi TabLineFill ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#040404 gui=NONE

hi Normal ctermfg=231 ctermbg=234 cterm=NONE guifg=#ecf0f1 guibg=#040404 gui=NONE
...
hi NonText ctermfg=22 ctermbg=234 cterm=NONE guifg=#30312a guibg=#040404 gui=NONE
...
hi SpecialKey ctermfg=22 ctermbg=236 cterm=NONE guifg=#f1530f guibg=#040404 gui=NONE

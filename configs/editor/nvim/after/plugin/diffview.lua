...
diffview.setup({
  ...
  keymaps = {
    ...
    view = {
      ...
      ["gf"] = actions.goto_file, -- Open the file in the previous tabpage
    ...
    diff1 = { -- Mappings in single window diff layouts
      ["g<tab>"] = actions.select_next_entry,
      ["g<S-tab>"] = actions.select_prev_entry,
    },
    ...
    diff3 = {
      ...
      [{ "g<tab>", "i", "x" }] = actions.select_next_entry,
      [{ "g<S-tab>", "i", "x" }] = actions.select_prev_entry,
    },
    diff4 = {
    ...
    file_panel = {
      ...
      ["R"] = actions.refresh_files, -- Update stats of the files in the list
